    %% Matlab code for creating a 3D surface mesh%% create a connectivity structure
    ...
    pcl = pcl.Location(indI,:);                      % select 3D points that are on resolution grid
    J1l = J1l.Location(indI,:);                      % select pixels that are on the resolution grid
    ...
    %% visualize
    figure; TM = trimesh(TR);                       % plot the mesh
